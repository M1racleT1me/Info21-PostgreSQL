...
$$
BEGIN
    EXECUTE format('COPY %s FROM %L WITH CSV HEADER DELIMITER %L', table_name, csv_file_path, delimiter);
END;
$$;

SET dataset_path.const TO '/opt/goinfre/ultronip/SQL2_Info21_v1.0-2/src/dataset_sql/import/';
